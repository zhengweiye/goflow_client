...
type ProcessInstanceService interface {
	 ...
	 * 全部
	 */
	GetAllList(query InstanceAllQuery) (totalElements, totalPage int64, list []InstanceAllList, err error)
	GetAllCount(query InstanceAllQuery) (count int, err error)

	/**
	 * 我发起
	 */
	GetCreateList(query InstanceCreateQuery) (totalElements, totalPage int64, list []InstanceCreateList, err error)
	GetCreateCount(query InstanceCreateQuery) (count int, err error)

	/**
	 * 待我审批
	 */
	GetTodoList(query InstanceTodoQuery) (totalElements, totalPage int64, list []InstanceTodoList, err error)
	GetTodoCount(query InstanceTodoQuery) (count int, err error)

	/**
	 * 我已审批
	 */
	GetDoneList(query InstanceDoneQuery) (totalElements, totalPage int64, list []InstanceDoneList, err error)
	GetDoneCount(query InstanceDoneQuery) (count int, err error)

	/**
	 * 抄送我的
	 */
	GetCcList(query InstanceCcQuery) (totalElements, totalPage int64, list []InstanceCcList, err error)
...
func (p ProcessInstanceServiceImpl) GetAllList(query InstanceAllQuery) (totalElements, totalPage int64, list []InstanceAllList, err error) {
	var param map[string]any
	err = mapstructure.Decode(query, &param)
	if err != nil {
		return
	}
	result, err := httpPost[PageData[InstanceAllList]](p.client, "client/instance/getAllList", param)
	if err != nil {
		return
	}
	if result.Code != 200 {
...
func (p ProcessInstanceServiceImpl) GetCreateList(query InstanceCreateQuery) (totalElements, totalPage int64, list []InstanceCreateList, err error) {
	var param map[string]any
	err = mapstructure.Decode(query, &param)
	if err != nil {
		return
	}
	result, err := httpPost[PageData[InstanceCreateList]](p.client, "client/instance/getCreateList", param)
	if err != nil {
		return
	}
	if result.Code != 200 {
...
func (p ProcessInstanceServiceImpl) GetTodoList(query InstanceTodoQuery) (totalElements, totalPage int64, list []InstanceTodoList, err error) {
	var param map[string]any
	err = mapstructure.Decode(query, &param)
	if err != nil {
		return
	}
	result, err := httpPost[PageData[InstanceTodoList]](p.client, "client/instance/getTodoList", param)
	if err != nil {
		return
	}
	if result.Code != 200 {
...
func (p ProcessInstanceServiceImpl) GetDoneList(query InstanceDoneQuery) (totalElements, totalPage int64, list []InstanceDoneList, err error) {
	var param map[string]any
	err = mapstructure.Decode(query, &param)
	if err != nil {
		return
	}
	result, err := httpPost[PageData[InstanceDoneList]](p.client, "client/instance/getDoneList", param)
	if err != nil {
		return
	}
	if result.Code != 200 {
...
func (p ProcessInstanceServiceImpl) GetCcList(query InstanceCcQuery) (totalElements, totalPage int64, list []InstanceCcList, err error) {
	var param map[string]any
	err = mapstructure.Decode(query, &param)
	if err != nil {
		return
	}
	result, err := httpPost[PageData[InstanceCcList]](p.client, "client/instance/getCcList", param)
	if err != nil {
		return
	}
	if result.Code != 200 {
...
type InstanceCreateList struct {
	Id            string              `json:"id"`
	BusinessId    string              `json:"businessId"`
	BusinessTitle string              `json:"businessTitle"`
	TypeCode      string              `json:"typeCode"` // 流程类型
